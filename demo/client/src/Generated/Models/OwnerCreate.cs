...
namespace PetStore.Models
{
    ...
    public partial class OwnerCreate
    {
        ...
        internal OwnerCreate(string name, int age, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Age = age;
        ...
        /// <summary> Initializes a new instance of <see cref="OwnerCreate"/> for deserialization. </summary>
